  ...
  init {
    addProcessListener(object : ProcessListener {
      override fun onProcessStart() {
        try {
          val stdOutReader = SimpleOutputReader(BaseInputStreamReader(process.inputStream), ProcessOutputType.STDOUT)
          val stdErrReader = SimpleOutputReader(BaseInputStreamReader(process.errorStream), ProcessOutputType.STDERR)
