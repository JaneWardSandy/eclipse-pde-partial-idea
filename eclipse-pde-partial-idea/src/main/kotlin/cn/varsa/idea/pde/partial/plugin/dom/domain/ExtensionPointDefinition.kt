...
class ExtensionPointDefinition {
  ...
  private fun findRefElement(
    ...
    return definition.elements.firstOrNull { it.name == ref.ref } ?: definition.includes.mapNotNull { schemaLocation ->
...
class ElementDefinition {
  companion object {
    ...
    private val attributePath =
      XPathFactory.instance().compile("*[local-name()='complexType']/*[local-name()='attribute']", Filters.element())
  }
...
class AttributeDefinition {
  companion object {
    ...
    private val simplePath =
      XPathFactory.instance().compile("*[local-name()='simpleType']/*[local-name()='restriction']", Filters.element())
