...
import cn.varsa.idea.pde.partial.common.Constants.OSGI.Header.BUNDLE_MANIFESTVERSION
...
class BasicBundleManifestHeaderParserProvider : HeaderParserProvider {
  ...
  override fun getHeaderParsers(): Map<String, HeaderParser> = mapOf(
    BUNDLE_MANIFESTVERSION to ManifestVersionParser,
    ...
    BUNDLE_REQUIREDEXECUTIONENVIRONMENT to RequiredExecutionEnvironmentParser,
    REQUIRE_BUNDLE to RequireBundleParser,
    IMPORT_PACKAGE to ImportPackageParser,
    EXPORT_PACKAGE to ExportPackageParser,
    FRAGMENT_HOST to FragmentHostParser,
    BUNDLE_CLASSPATH to BundleClasspathParser,
